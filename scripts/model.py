...
class Model:
    ...
    '''
    def __init__(self, categorized_neurons, G_e = 3.7, G_i = -1, runtime = 17988, gamma_rate = 40, theta_rate = 7):
...
class Model1(Model):
    ...
    def initialize_connectivity_matrix_normal_distribution(self):
        ...
        num_pyr = len(self.categorised_neurons['Place'])
        num_int = len(self.categorised_neurons['Interneuron'])
